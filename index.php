...
<body>
    ...
    <div class="container-fluid">
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav col-md-9">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="src/Dev.php">O DESENVOLVEDOR</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="src/PerguntasFreq.php">PERGUNTAS FREQUENTES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="src/CirurgiaSeg.php">CIRURGIA SEGURA</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">BLOG</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="src/FaleConosco.php">FALE CONOSCO</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div id="carouselExample" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="src/IMG/foto1.jpg" class="d-block" alt="...">
      </div>
      <div class="carousel-item">
        <img src="src/IMG/foto2.jpg" class="d-block" alt="...">
      </div>
      <div class="carousel-item">
        <img src="src/IMG/foto3.jpg" class="d-block" alt="...">
      </div>
      <div class="carousel-item">
        <img src="src/IMG/foto4.jpg" class="d-block" alt="...">
      </div>
    </div>
  ...
  <div class="container pt-5">
    <div class="row d-flex justify-content-around">
      <div class="col-sm-12 col-xl-4 pb-4">
        <div class="card h-100">
          <img src="src/IMG/foto5.jpg" class="card-img-top" alt="...">
          <div class="card-body ">
            <div class="pt-3 pl-3">
  ...
  <div class="bg-warning">
    <div class="row justify-content-around">
      ...
      <div class="col-md-7 col-sm-12">
        <div class="h-100">
          <img src="src/IMG/foto6.jpg" alt="Imagem de exemplo" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="right col-md-6">
        ...
        <div>
          <p>Para mais informações,<a class="text-warning link-underline link-underline-opacity-0" href="src/FaleConosco.php"> <b>entre em
