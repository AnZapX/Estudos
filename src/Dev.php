...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary mt-5 pt-5">
    ...
    <div class="row justify-content-start bg-color">
    ...
    <div>
      <b><p class="fs-3 text-center text-warning mb-0 mt-5 mb-3">Produção Bibliográfica</p></b>
    </div>
    ...
    <div class="row justify-content-start bg-gray">
      <div class="col-md-2"></div>
      <div class="col-md-3 col-sm-12 m-3">
        <div>
          <img src="IMG/Guia.jpg" alt="Livro Guia Do Mochileiro das Galáxias">
        </div>
      </div>
    </div>
    ...
    <div class="bg-warning">
      <div class="container">
        <div class="row d-flex justify-content-around">
          <div class="col-md-6 h3 mt-5 mb-5">
            <p>
              Quem valoriza e se preocupa com seu corpo escolhe o melhor para a sua vida. Especialista em cirurgia estética e reparadora em Goiânia-GO.
            </p>
          </div>
          <div class="col-md-6 h3 mt-5 mb-5">
            <p>
              Para realizar seu sonho, conte com um profissional especialista em cirurgia estética e reparadora em Goiânia-GO.
              Dr. Mário Junqueira
            </p>
          </div>
        </div>
    ...
    <div class="container mb-4 mt-4">
      <div class="row h4">
        <div class="col-md-7 col-sm-12">
          <i class="bi bi-airplane-engines h1"></i>
      ...
      <div class="row justify-content-around">
        <div class="col-md-5 col-sm-12">
          <div class="p-4">
            ...
            <a href="#"><button type="button" class="btn btn-warning">Continue lendo ></button></a>
          </div>
        </div>
        <div class="col-md-7 col-sm-12">
          <div class="h-100">
